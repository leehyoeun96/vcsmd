...
int main(int argc, char**argv)
{
    ...
    //    ros::Subscriber proxy_sub = nh.subscribe("/estimate_twist",1,twistCallback);
    ros::Subscriber proxy_sub1 = nh.subscribe("/current_velocity",1,curVelCallback);
