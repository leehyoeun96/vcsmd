...
typedef struct UserMsg {
    ...
    UserMsg(int s_no, int a_no, int c_code, int p_id, double p_val, int r_code, char *s) {seq_no = s_no; ack_no = a_no; cmd_code = c_code; param_id = p_id; param_val = p_val; result_code = r_code; result_msg = string(s); }
    int seq_no;
    int ack_no;
