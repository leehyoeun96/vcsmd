   ...
   while(1)
   {
        ...
        else if(fullsd > 0)
        {
            ...
            {//vcsd exec
                ...
                //if(execl("/home/qjin/rubicom/control_server_mm/VCFserver_pc.exe", "./VCFserver_pc.exe", "", NULL) == -1)
                execl("/home/pi/qjin/Ichthus/ichthus/vehicle/control_server_mm/VCFserver_rpi.exe", "VCFserver_rpi.exe", "", NULL);
                syslog(LOG_ERR, "no VCFSERVER_rpi VCS\n");
                execl("/home/qjin/rubicom/control_server_mm/VCFserver_pc.exe", "VCFserver_pc.exe", "", NULL);
