...
struct GWAY1{
	...
	average_velocity = (Gway_Wheel_Velocity_FR + Gway_Wheel_Velocity_RL + Gway_Wheel_Velocity_RR + Gway_Wheel_Velocity_FL) / 4.0;
        set_rtParam("CAN.actual_velocity", "value", average_velocity);
