...
{ // NOT COMPLETE!!!
    ...
    else if (regexec_with_args(&regex_get, msg, 2, groups, arg1, NULL))
    {
        ...
        umsg.param_val = 0;
        if( strcasecmp(arg1, "CAN.cluster_odometer") == 0) umsg.param_id = 0;
        else {
            umsg.result_code = -1;
    ...
    else if (regexec_with_args(&regex_set, msg, 3, groups, arg1, arg2))
    {
        ...
        if( (strcasecmp(arg1, "throttle.target_position") == 0) |  (strcasecmp(arg1, "t.tpos") == 0) ) umsg.param_id = 6;
        else if( strcasecmp(arg1, "brake.target_position") == 0 | (strcasecmp(arg1, "b.tpos") == 0) ) umsg.param_id = 7;
        else if( strcasecmp(arg1, "lidar.center_target_position") == 0  | (strcasecmp(arg1, "l.ctpos") == 0)) umsg.param_id = 8;
        else if( strcasecmp(arg1, "lidar.left_target_position") == 0 | (strcasecmp(arg1, "l.ltpos") == 0) )umsg.param_id = 9;
        else if( strcasecmp(arg1, "lidar.right_target_position") == 0 | (strcasecmp(arg1, "l.rtpos") == 0) )umsg.param_id = 10;
        else if( strcasecmp(arg1, "poselidar.mode") == 0 | (strcasecmp(arg1, "pl.mode") == 0)) umsg.param_id = 11;
        else if( strcasecmp(arg1, "steerwheel.target_position") == 0 | (strcasecmp(arg1, "s.tpos") == 0)) umsg.param_id = 12;
        else if( strcasecmp(arg1, "gearstick.target_position") == 0 | (strcasecmp(arg1, "g.tpos") == 0)) umsg.param_id = 13;
        else if( strcasecmp(arg1, "cruisecontrol.target_velocity") == 0 | (strcasecmp(arg1, "cc.tvelo") == 0)) umsg.param_id = 14;
        else if( strcasecmp(arg1, "steercontrol.target_angular_velocity") == 0 | (strcasecmp(arg1, "sc.tanvelo") == 0)) umsg.param_id = 15;
        else if( strcasecmp(arg1, "hvi.mode") == 0) umsg.param_id = 16;
        else {
            umsg.result_code = -1;
            printf("Unknown command\n");
        } 
